! function (e) {
    ...
    function o() {
        ...
        e(".product-slider-thumb").find(".owl-item").removeClass("synced").eq(a).addClass("synced"), void 0 !== e(".product-slider-thumb").data("owlCarousel") && r(a)
    }
    ...
    e.fn.imageCover = function () {
        ...
        s(), l(), c(), g(), d(), p(), h(), u(), e("#header-page nav").hasClass("awe-navigation-hamburger") && e("#header-page nav").attr("data-responsive", 1e5), w.iOS() && e(".awe-parallax, .awe-static").addClass("fix-background-ios"), e(".write-review").on("click", function (a) {
